...
const theme = createTheme({
  palette: {
    primary: { main: "#217178", contrastText: "#ffffff" },
    secondary: { main: "#f57c00", contrastText: "#ffffff" },
    success: { main: "#388e3c", contrastText: "#ffffff" },
    error: { main: "#d32f2f", contrastText: "#ffffff" },
    warning: { main: "#ffa000", contrastText: "#000000" },
    info: { main: "#8e24aa", contrastText: "#ffffff" },
    background: { default: "#f9f9f9", paper: "#ffffff" },
    text: { primary: "#3c4043", secondary: "#3c4043" }
  }
});
